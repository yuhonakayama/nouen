...
<head>
  ...
  <meta property="og:image" content="<?php echo get_theme_file_uri('/images/ogp-image.png'); ?>" />
  ...
  <script src="<?php echo get_theme_file_uri('/js/index.js'); ?>" defer></script>
</head>
  ...
  <header class="header js-header">
    <div class="header__inner">
      <div class="header__content">
        <h1 class="header__name"><img src="<?php echo get_theme_file_uri('/images/logo.svg'); ?>" alt="自然の恵み農園"></h1>
    ...
    <div class="drawer-menu__inner">
      <ul class="drawer-menu__items">
        <li class="drawer-menu__item">
          <a href="<?php echo home_url('/'); ?>" class="drawer-menu__link">トップ<span class="drawer-menu__link--en">TOP</span></a>
        </li>
        <li class="drawer-menu__item">
          <a href="<?php echo home_url('/#about'); ?>" class="drawer-menu__link">私たちについて<span class="drawer-menu__link--en">ABOUT</span></a>
        </li>
        <li class="drawer-menu__item">
          <a href="<?php echo home_url('/#faq'); ?>" class="drawer-menu__link">よくあるご質問<span class="drawer-menu__link--en">FAQ</span></a>
        </li>
        <li class="drawer-menu__item">
          <a href="<?php echo home_url('/#works'); ?>" class="drawer-menu__link">活動紹介<span class="drawer-menu__link--en">WORKS</span></a>
        </li>
        <li class="drawer-menu__item">
          <a href="<?php echo home_url('/news.html'); ?>" class="drawer-menu__link">お知らせ<span class="drawer-menu__link--en">NEWS</span></a>
        </li>
        <li class="drawer-menu__item">
          <a href="<?php echo home_url('/#access'); ?>" class="drawer-menu__link">アクセス<span class="drawer-menu__link--en">ACCESS</span></a>
        </li>
      </ul>
      <div class="drawer__contact">
        ...
        <div class="drawer__button button--header">
          <a href="<?php echo home_url('/contact-page.html'); ?>" class="button__link--header">お問い合わせ</a>
        </div>
      </div>
    </div>
  </div>
  ...
  <footer class="footer">
    <div class="footer__inner inner">
      <div class="footer__logo">
        <img src="<?php echo get_theme_file_uri('/images/logo.svg'); ?>" alt="自然の恵み農園">
      </div>
      <div class="footer__nav">
        <ul class="footer__nav-list">
          <li class="footer__nav-item">
            <a href="<?php echo home_url('/'); ?>" class="footer__nav-link">ホーム</a>
          </li>
          <li class="footer__nav-item">
            <a href="<?php echo home_url('/#about'); ?>" class="footer__nav-link">私たちについて</a>
          </li>
          <li class="footer__nav-item">
            <a href="<?php echo home_url('/#works'); ?>" class="footer__nav-link">活動紹介</a>
          </li>
          <li class="footer__nav-item">
            <a href="<?php echo home_url('/#faq'); ?>" class="footer__nav-link">よくあるご質問</a>
          </li>
          <li class="footer__nav-item">
      ...
      <div class="footer__sns">
        <div class="sns__icon">
          <a href="<?php echo home_url('/'); ?>" class="sns__icon-link"><img src="<?php echo get_theme_file_uri('/images/x-icon.svg'); ?>" alt="X"></a>
        </div>
        <div class="sns__icon">
          <a href="<?php echo home_url('/'); ?>" class="sns__icon-link"><img src="<?php echo get_theme_file_uri('/images/insta-icon.svg'); ?>" alt="Instagram"></a>
          </div>
        <div class="sns__icon">
          <a href="<?php echo home_url('/'); ?>" class="sns__icon-link"><img src="<?php echo get_theme_file_uri('/images/youtube-icon.svg'); ?>" alt="YouTube"></a>
        </div>
      </div>
